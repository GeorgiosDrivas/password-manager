        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-200/50 dark:shadow-black/50 border border-white/20 dark:border-slate-800/50 overflow-hidden">
          <div className="px-8 pt-10 pb-6 text-center">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-2xl bg-linear-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/25"
            >
          ...
          <div className="px-8 pb-8">
            ...
            <form onSubmit={handleSubmit(handleSignup)} className="space-y-5">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="cursor-pointer w-full mt-6 bg-linear-to-r from-emerald-500 to-teal-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all duration-300 disabled:opacity-70"
              >
                {isSubmitting ? (
