...
import { loginSchema, LoginSchemaType } from '../shared/auth/schemas/loginSchema';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-linear-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-4">
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-200/50 dark:shadow-black/50 border border-white/20 dark:border-slate-800/50 overflow-hidden">
          <div className="px-8 pt-10 pb-6 text-center">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-2xl bg-linear-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/25 relative"
            >
          ...
          <div className="px-8 pb-8">
            ...
            <form onSubmit={handleSubmit(handleLogin(() => {}))} className="space-y-5">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="cursor-pointer w-full mt-8 relative overflow-hidden group bg-linear-to-r from-emerald-500 to-teal-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-500/25 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-emerald-500/40 hover:shadow-xl"
              >
